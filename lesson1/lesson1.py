...
def main():
    ...
    ############################################################
    idx = range(1, 10)
        {"TV":pd.Series([230.1, 44.5, 17.2, 151.5, 180.8, 8.7, 57.5, 120.2, 8.6], index=idx),
    ...
    print("Problem 7 - Number of observations in dataframe is ", (house_data.shape[0])*house_data.shape[1])
